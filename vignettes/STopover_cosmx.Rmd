...
```{r, echo=FALSE, eval=FALSE}
sp_data_list <- readr::read_rds('/home/nmadmin/DATA2/STopover/vignettes/sp_lung_cancer_list.rds')
```
...
```
```{r, echo=FALSE, eval=FALSE}
sp_data_grid_celltype <- readr::read_rds('/home/nmadmin/DATA2/STopover/vignettes/sp_data_grid_celltype.rds')
```
...
```{r, eval=FALSE, fig.width=8, fig.height=3.5}
...
```
```{r, eval=FALSE, echo=FALSE}
sp_data_merge_lr <- readr::read_rds('/home/nmadmin/DATA2/STopover/vignettes/sp_data_merge_lr.rds')
```
...
```
```{r, eval=FALSE, echo=FALSE}
sp_celltype_spec_lr <- readr::read_rds('/home/nmadmin/DATA2/STopover/vignettes/sp_celltype_spec_lr.rds')
```
